...
<html>
    ...
    <body>
        <h1 class="text-logo"><span class="glyphicon glyphicon-cutlery"></span> SamaBurger
        ...
        <div class="container admin">
            <div class="row">
                ...
                <div class="col-sm-6 site">
                    <div class="thumbnail">
                        <img src="<?php echo '../pics/'.$item['image'];?>" alt="menu1">
                        <div class="price"><?php echo number_format((float)$item['price'],2,',','');?> €</div>
                        <div class="caption">
                            <h4><?php echo $item['name'];?></h4>
                            <p><?php echo $item['description'];?></p>
                            <a href="#" class="btn-order" role="button"><span class="glyphicon glyphicon-shopping-cart"></span> Commander</a>
                        </div>
                    </div>
                </div>
